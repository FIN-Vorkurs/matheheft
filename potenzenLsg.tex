...
\begin{multicols}{2}
	...
	\item \quad $ \frac{(2x-4)^5}{(2-x)^3}=-32(x-2)^2 $																	%31
...
\begin{multicols}{2}
	...
	\item \quad $ \frac{(2x-6)^2}{4}=(x-3)^2 $																			%48
	\item \quad $ \frac{(-2a-4)^3}{a+2}=-8(a+2)^2 $																		%49
	\end{multicols} 
\end{enumerate}
\newpage
...
\begin{multicols}{2}
	...
	\item \quad $ \frac{(3x^2-6x^3)^2}{9x^4}=(1-2x)^2 $										% 2
	\item \quad $ \frac{5x+15}{x+3}=5 $														% 3
	\item \quad $ \frac{e^{3x}+e^{2x}}{e^{2x}}=e^x + 1 $											% 4
	\item \quad $ \frac{x^4-6x^3}{5x-30}=\frac{x^3}{5} $								% 5	
	\item \quad $ \frac{a^7b^3-ab^7}{a^5b-a^2b^4}=\frac{a^6b^2-b^6}{a^4-ab^3} $	% 6
	\item \quad $ \frac{3+6x^2}{2x} - \frac{6x^3-5}{3x^2} - \frac{2x^4-2}{2x^3}=\frac{9x^2+10x+6}{6x^3} $			% 7
...
%\begin{multicols}{2}
	...
	\item \quad $ a^{k-2}+a^{3k}+a^{-k-1} = a^{-k}(a^{2k-2}+a^{4k} +a^{-1}) $	% 2
...
\begin{multicols}{2}
	...
	\item \quad $ 4t^2 \cdot t^{-3} - t \cdot t^{-2} =3t^{-1} $														%12		
...
%\begin{multicols}{2}
	...
	\item \quad $ 5 \cdot 2^{n+1} - 2^n + 8 \cdot 2^{n-2} - 12 \cdot 2^{n-1}=5\cdot 2^n $												%18
